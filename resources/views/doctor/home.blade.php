      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> +63 900 0000 000</a>
              <span class="divider">|</span>
              <a href="#"><span class="mai-mail text-primary"></span>hospitalmgmt115@gmail.com</a>
            </div>
          </div>
  ...
  <footer class="page-footer">
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          <h5>Contact</h5>
          <p class="footer-link mt-2">Somewhere in Metro Manila</p>
          <a href="#" class="footer-link">Number ni PLDT</a>
          <a href="#" class="footer-link">hospitalmgmt115@gmail.com</a>
